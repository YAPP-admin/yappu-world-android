...
sealed interface SessionIntent {
    ...
    data class ClickKakaoMap(val name: String, val latitude: Double, val longitude: Double) : SessionIntent
    data class ClickNaverMap(val latitude: Double, val longitude: Double, val name: String) : SessionIntent
...
sealed interface SessionSideEffect {
    ...
    data class OpenKakaoMap(val name: String, val latitude: Double, val longitude: Double) : SessionSideEffect
    data class OpenNaverMap(val latitude: Double, val longitude: Double, val name: String) : SessionSideEffect
